...
import 'package:xhalona_pos/views/home/fragment/dashboard/views/summary_card.dart';
import 'package:xhalona_pos/views/home/fragment/dashboard/views/today_trx_table.dart';
        ...
        child: Column(
          ...
          children: [
            ...
            ConstrainedBox(
              ...
              child: renderTodayTrxTable(state: state)
            ),
            Row(
              children: [
                Expanded(
                  child: renderSummaryTrxToday(
                    state: state
                  )
                ),
                Expanded(
                  child: renderSummaryTrxMonth(
                    state: state
                  )
                )
              ],
              ...
              //           Text(formatToRupiahShort(number: controller.nettoValDToday.value), style: AppTextStyle.textSubtitleStyle(
              //             color: AppColor.whiteColor
              //           ),),
              //           Text(
