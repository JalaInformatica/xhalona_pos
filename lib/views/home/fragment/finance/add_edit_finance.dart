...
import 'package:xhalona_pos/views/home/fragment/finance/kasbankdetail/kasbankdetail_screen.dart';
...
class _AddEditFinanceState extends State<AddEditFinance> {
  ...
  final KasBankDetailController controllerKbt =
      Get.put(KasBankDetailController());
                              ...
                              children: [
                                IntrinsicWidth(
                                  child: AppElevatedButton(
                                      ...
                                      onPressed: () {
                                        controllerKbt.updateVoucher(
                                            widget.finance!.voucherNo);
                                        Navigator.of(context).push(
                                            MaterialPageRoute(
                                                builder: (context) =>
                                                    KasBankDetailScreen(
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                Expanded(
                                  ...
                                  icon: Icons.post_add,
                                  backgroundColor: widget.finance != null &&
                                          widget.finance!.isApproved
                                  ...
                                  child: widget.finance != null &&
                                      ...
                                      ? Text(
                                          'UnPost',
                                          style:
                                              AppTextStyle.textSubtitleStyle(),
                                        )
                                      : Text('Post',
                                          style:
                                              AppTextStyle.textSubtitleStyle()),
