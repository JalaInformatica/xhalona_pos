  ...
  void adjustPembayaran(int key, String amount) {
    ...
    switch (key) {
      ...
      case 2: 
        ...
        break;
      case 3: 
        _controller.komplimen.value = parsedAmount; 
        break;
      case 4: 
    ...
    if (_controller.totalPaid.value >= widget.nettoVal) {
      _controller.kembalian.value = _controller.totalPaid.value - widget.nettoVal;
    }
  ...
  Widget build(BuildContext context) {
    return SafeArea(child: Scaffold(
      ...
      body: Column(
        children: [
          Padding(
            padding: EdgeInsets.only(top: 15.h, left: 15.w, right: 5.w, bottom: 15.h),
            child: Row(
          ...
          ListView(
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    Text(formatToRupiah(widget.brutoVal), style: AppTextStyle.textBodyStyle(),),
                  ],
                ),
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  ...
                  Text(formatToRupiah(widget.discVal), style: AppTextStyle.textBodyStyle(),),
                  ],
                ),
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                ...
                Text(formatToRupiah(widget.nettoVal), style: AppTextStyle.textSubtitleStyle(),),
              ],),
              ...
              children: [
                ...
                Expanded(
                  ...
                  child: Obx(()=> AppTextField(
                    ...
                    textEditingController: _tunaiController..text=formatThousands(_controller.tunai.value.toString()),
              ...
              children: [
                ...
                Expanded(
                  ...
                  child:Obx(()=> AppTextField(
                    isThousand: true,
                    unfocusWhenTapOutside: false,
                    textEditingController: _nonTunai1Controller..text=formatThousands(_controller.nonTunai1.value.toString()),
                    contentPadding: EdgeInsets.symmetric(horizontal: 8.w, vertical: 8.h),
                    context: context, 
                    hintText: "0", 
                    textAlign: TextAlign.right,
              ...
              children: [
                ...
                Expanded(
                  ...
                  child: Obx(()=> AppTextField(
                    isThousand: true,
                    unfocusWhenTapOutside: false,
                    textEditingController: _nonTunai2Controller..text=formatThousands(_controller.nonTunai2.value.toString()),
                    contentPadding: EdgeInsets.symmetric(horizontal: 8.w, vertical: 8.h),
                    context: context, 
                    hintText: "0", 
                    textAlign: TextAlign.right,
              ...
              children: [
                ...
                Expanded(
                  ...
                  child: Obx(()=> AppTextField(
                    isThousand: true,
                    unfocusWhenTapOutside: false,
                    textEditingController: _nonTunai3Controller..text=formatThousands(_controller.nonTunai3.value.toString()),
                    contentPadding: EdgeInsets.symmetric(horizontal: 8.w, vertical: 8.h),
                    context: context, 
                    hintText: "0", 
                    textAlign: TextAlign.right,
              ...
              children: [
                ...
                Expanded(
                  ...
                  child: Obx(()=> AppTextField(
                    isThousand: true,
                    unfocusWhenTapOutside: false,
                    textEditingController: _komplimenController..text=formatThousands(_controller.komplimen.value.toString()),
                    contentPadding: EdgeInsets.symmetric(horizontal: 8.w, vertical: 8.h),
                    context: context, 
                    hintText: "0", 
                    textAlign: TextAlign.right,
              ...
              children: [
                ...
                Expanded(
                  ...
                  child: Obx(()=> AppTextField(
                    isThousand: true,
                    unfocusWhenTapOutside: false,
                    textEditingController: _hutangController..text=formatThousands(_controller.hutang.value.toString()),
                    contentPadding: EdgeInsets.symmetric(horizontal: 8.w, vertical: 8.h),
                    context: context, 
                    hintText: "0", 
                    textAlign: TextAlign.right,
              ...
              children: [
                ...
                Expanded(
                  ...
                  child: Container(
                    ...
                    child: Obx(()=> AppTextField(
                    textEditingController: _totalController..text=formatThousands(_controller.totalPaid.value.toString()),
                    readOnly: true,
                    isThousand: true,
                    unfocusWhenTapOutside: false,
                    contentPadding: EdgeInsets.symmetric(horizontal: 8.w, vertical: 8.h),
              ...
              children: [
                ...
                Expanded(
                  ...
                  child: Obx(()=> AppTextField(
                    isThousand: true,
                    unfocusWhenTapOutside: false,
                    textEditingController: _kembalianController..text=formatThousands(_controller.kembalian.value.toString()),
                    contentPadding: EdgeInsets.symmetric(horizontal: 8.w, vertical: 8.h),
                    context: context, 
                    hintText: "0", 
                    textAlign: TextAlign.right,
                    onChanged: (val){
                      if(unFormatThousands(val)>_controller.totalPaid.value-widget.nettoVal){
                        _controller.kembalian.value = _controller.totalPaid.value-widget.nettoVal;
                        _controller.titipan.value = 0;
                      }
                      else {
                        _controller.kembalian.value = unFormatThousands(val);
                        _controller.titipan.value = _controller.totalPaid.value -widget.nettoVal - unFormatThousands(val);
                      }
                    },
                  ))
                ),
              ...
              children: [
                ...
                Expanded(
                  ...
                  child: Obx(()=> AppTextField(
                    isThousand: true,
                    unfocusWhenTapOutside: false,
                    textEditingController: _titipanController..text=formatThousands(_controller.titipan.value.toString()),
                    contentPadding: EdgeInsets.symmetric(horizontal: 8.w, vertical: 8.h),
                    context: context, 
                    hintText: "0", 
                    textAlign: TextAlign.right,
                    onChanged: (val){
                      if(unFormatThousands(val)>(_controller.totalPaid.value-widget.nettoVal)){
                        _controller.titipan.value = _controller.totalPaid.value-widget.nettoVal;
                        _controller.kembalian.value = 0;
                      }
                      else {
                        _controller.titipan.value = unFormatThousands(val);
                        _controller.kembalian.value = _controller.totalPaid.value - widget.nettoVal - unFormatThousands(val);
                      }
                    },
                  ))
                ),
            ...
            SizedBox(height: 10.h,),
              ...
              child: Obx(()=> AppElevatedButton(
                disabled: _controller.totalPaid.value<widget.nettoVal,
