...
class MasterVarianScreen extends StatelessWidget {
  MasterVarianScreen({super.key});
          ...
          child: Column(
            ...
            children: [
              ...
              Obx(() => Expanded(
                    ...
                    titles: [
                      AppTableTitle(value: "Sub Varian"),
                    ...
                    data: List.generate(controller.kategoriHeader.length,
                      ...
                      return [
                        AppTableCell(
                            ...
                            onDelete: () async {
                              await messageHapus(
                                  kategori.varId, kategori.varName);
                            },
  ...
  Future<dynamic> messageHapus(String varId, String varName) {
    return SmartDialog.show(builder: (context) {
      return AlertDialog(
          ...
          content: Text(
            "Apakah Anda yakin ingin menghapus data '$varName'?",
            maxLines: 2,
          ...
          actions: [
            ...
            TextButton(
              onPressed: () async {
                String result =
                    await _kategoriRepository.deleteVarian(varId: varId);
  ...
  Future<dynamic> goTo(BuildContext context, VarianDAO kategori) {
    return Navigator.of(context).pushAndRemoveUntil(
        MaterialPageRoute(
            builder: (context) => AddEditVarian(kategori: kategori)),
        (route) => false);
  }
}
